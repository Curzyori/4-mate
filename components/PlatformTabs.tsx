      ...
      {PLATFORMS.map((platform) => {
        ...
        return (
          <button
            ...
            className={`relative flex items-center gap-1.5 rounded-sm px-3 py-2 text-sm font-medium transition-all duration-200 md:gap-2 md:px-4 md:py-2.5 ${
              isActive
                ? "text-on-primary shadow-sm"
                : "text-mute hover:text-ink hover:bg-gray-50"
            }`}
            style={
